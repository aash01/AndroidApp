package com.example.aashr.facerecognition;
...
//    public FirebaseDatabase database = FirebaseDatabase.getInstance().getReference();
    public DatabaseReference myRef = FirebaseDatabase.getInstance().getReference("LockStatus");
    private Button log;
    private Switch lock;
